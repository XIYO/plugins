...
All notable changes to Apple Calendar will be documented in this file. Releases follow Semantic Versioning for the plugin and runtime package; calendar-note schemas use their own `MAJOR.MINOR` compatibility version.
